...
另請同步你維護的兩份文件中之扇子表述:`03_規格/發現之前_第一章美術製作附錄_v0.2.md`、`art/style/ART-ADR-001`(「持扇錯愕」→「翻頁停在半空」)。劇本與 debate 資料已由 Claude 同步完畢(劇本 v0.2.1),**請勿改 04_劇本**(作者/審稿分離)。重生不阻擋 P-5 選圖(風格與構圖不變,僅道具)。
