...
## 十三、2026-08-14｜第四章 Newton 成年期共用成熟版肖像

| 資產 ID | 用途與史實邊界 | 母版 | runtime | 工具／日期 | 提示與編修紀錄 | 衍生參數 | 狀態 |
|---|---|---|---|---|---|---|---|
| `dialogue_newton41` | 1679–1687 成年期共用合理重建（約 36–44 歲；造型以 1684 前後為代表）；強化小尺寸年齡辨識，不宣稱每一年同貌、同齡寫真或唯一面貌 | `art/source/production/ch04/characters/ch04_char_newton41_alpha_v03.png` | `public/assets/ch04/characters/ch04_char_newton41_v04.webp` | OpenAI 內建 imagegen identity-preserve／2026-08-14 | `ch04/characters/PROMPTS_CH04_NEWTON41_MATURE_V04_20260814.md` | chroma-key helper 去背＋`render-ch4-portraits.py`；900×1200 WebP q88、alpha q100 | generated／reviewed／browser pending |

## 十四、2026-08-14｜第四章 K4 現代重算身分與 K5 六段證明鏈

| 資產 ID | 用途與史實邊界 | 母版 | runtime | 工具／日期 | 提示與編修紀錄 | 衍生參數 | 狀態 |
|---|---|---|---|---|---|---|---|
| `card_K4_no_loans_raster_v03` | K4 未加補充紙世界線；精確殘差與週期差是固定簡化模型的現代教學重算，不是十七世紀原始對帳表 | `art/source/production/ch04/evidence/ch04_card_K4_model_comparison_no_loans_raster_candidate_v03.png` | `public/assets/ch04/evidence/ch04_card_K4_model_comparison_no_loans_raster_v03.webp` | OpenAI image generation／2026-08-09 | `ch04/evidence/PROMPTS_CH04_EVIDENCE_RASTER_WITH_TEXT_V02_20260809.md` | 1586×992 完整扁平 raster；runtime 不疊圖 | generated／reviewed／Art Locked |
| `card_K4_planets_loan_raster_v03` | K4 只為行星加黃色補充紙世界線；補充假設不改寫原結果，史實邊界同上 | `art/source/production/ch04/evidence/ch04_card_K4_model_comparison_planets_loan_raster_candidate_v03.png` | `public/assets/ch04/evidence/ch04_card_K4_model_comparison_planets_loan_raster_v03.webp` | OpenAI image generation／2026-08-09 | 同上 | 1586×992 完整扁平 raster；runtime 不疊圖 | generated／reviewed／Art Locked |
| `card_K4_comet_loan_raster_v03` | K4 只為彗星加黃色補充紙世界線；補充假設不改寫原結果，史實邊界同上 | `art/source/production/ch04/evidence/ch04_card_K4_model_comparison_comet_loan_raster_candidate_v03.png` | `public/assets/ch04/evidence/ch04_card_K4_model_comparison_comet_loan_raster_v03.webp` | OpenAI image generation／2026-08-09 | 同上 | 1586×992 完整扁平 raster；runtime 不疊圖 | generated／reviewed／Art Locked |
| `card_K4_both_loans_raster_v04` | K4 兩張黃色補充紙世界線；補充假設不改寫原結果，史實邊界同上 | `art/source/production/ch04/evidence/ch04_card_K4_model_comparison_both_loans_raster_candidate_v04.png` | `public/assets/ch04/evidence/ch04_card_K4_model_comparison_both_loans_raster_v04.webp` | OpenAI image generation＋定點編修／2026-08-09 | 同上 | 1586×992 完整扁平 raster；runtime 不疊圖 | generated／reviewed／Art Locked |
| `card_K5`（v02） | K5 取得後六段證明鏈教學圖：五份既得證據接上球殼定理，並列 Hooke、Halley、Flamsteed、Newton 的工作分工與未知機制邊界；不是《Principia》原頁 | 程式繪製 SVG（本檔即正本） | `public/assets/ch04/evidence/ch04_card_K5_scoped_proof_v02.svg` | 專案程式繪圖／2026-08-14 | `01_治理/發現之前_CH4-CR-018_哈雷來訪後對話式科學高潮與出版收束_20260814.md` | 1200×750 SVG，完整文字與幾何同檔；舊 v01 保留追溯 | generated／review pending |
| `card_K4_no_loans_raster_v04` | K4 未加補充紙世界線白話封版；兩個未借狀態改為「原結果保留」，固定現代重算內容不變 | `art/source/production/ch04/evidence/ch04_card_K4_model_comparison_no_loans_raster_candidate_v04.png` | `public/assets/ch04/evidence/ch04_card_K4_model_comparison_no_loans_raster_v04.webp` | OpenAI imagegen 定點編修／2026-08-14 | `ch04/evidence/PROMPTS_CH04_EVIDENCE_RASTER_FINAL_V03_20260814.md` | 1586×992，WebP q91；完整扁平 raster | generated／reviewed／runtime selected |
| `card_K4_planets_loan_raster_v04` | K4 只借行星白話封版；Comet 未借狀態改為「原結果保留」，黃色借條與固定內容不變 | `art/source/production/ch04/evidence/ch04_card_K4_model_comparison_planets_loan_raster_candidate_v04.png` | `public/assets/ch04/evidence/ch04_card_K4_model_comparison_planets_loan_raster_v04.webp` | OpenAI imagegen 定點編修／2026-08-14 | 同上 | 1586×992，WebP q91；完整扁平 raster | generated／reviewed／runtime selected |
| `card_K4_comet_loan_raster_v04` | K4 只借彗星白話封版；Planets 未借狀態改為「原結果保留」，黃色借條與固定內容不變 | `art/source/production/ch04/evidence/ch04_card_K4_model_comparison_comet_loan_raster_candidate_v04.png` | `public/assets/ch04/evidence/ch04_card_K4_model_comparison_comet_loan_raster_v04.webp` | OpenAI imagegen 定點編修／2026-08-14 | 同上 | 1586×992，WebP q91；完整扁平 raster | generated／reviewed／runtime selected |
| `card_K4_both_loans_raster_v05` | K4 兩格都借白話封版；底部總結改為「原先兩格對不上」，兩張黃色借條與固定內容不變 | `art/source/production/ch04/evidence/ch04_card_K4_model_comparison_both_loans_raster_candidate_v05.png` | `public/assets/ch04/evidence/ch04_card_K4_model_comparison_both_loans_raster_v05.webp` | OpenAI imagegen 定點編修／2026-08-14 | 同上 | 1586×992，WebP q91；完整扁平 raster | generated／reviewed／runtime selected |
| `card_K5`（raster v03） | K5 取得後六段證明鏈歷史紙面校樣；逐字列出六段鏈、四人工作分工與未知機制邊界；不是《Principia》原頁 | `art/source/production/ch04/evidence/ch04_card_K5_scoped_proof_raster_candidate_v03.png` | `public/assets/ch04/evidence/ch04_card_K5_scoped_proof_raster_v03.webp` | OpenAI imagegen／2026-08-14 | 同上 | 1536×1024，WebP q91；文字烘焙入完整扁平 raster | generated／reviewed／runtime selected |

K4 四張 raster 內的「借條」是場內先以黃色補充紙定義後的物件俗稱，可以保留。2026-08-14 已以新版本完整扁平 raster 清除圖內「失配保留」：未借格改為「原結果保留」，兩格都借總結改為「原先兩格對不上」。舊 Art Lock 檔仍保留作 provenance，不再由 runtime resolver 選用。
