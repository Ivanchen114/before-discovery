...
(function (root) {
 ...
 "evidenceVisual": {
  ...
  "K2": {
   "items": [
    {
     "asset": "card_K2_cross_scale_reconstruction_v02",
     "alt": "燭光書桌上的兩張教學重建紙：左紙記地表一秒落下約四點九公尺，右紙記月球距地約六十個地球半徑、六十秒向內偏折約四點九公尺，中間以六十乘六十等於三千六百連起兩張紙"
    }
   ],
   "caption": "教學重建｜兩張同尺紙對齊：反平方律把地表一秒落下與月球六十秒偏折接到同一量級。"
  },
  "K3": {
   "items": [
    {
