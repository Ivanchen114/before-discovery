 ...
 "chapter": {
  ...
  "pillars": {
   "P2": {
    ...
    "reasonMode": "player",
    "requirePress": true,
    "responsePrompt": "帶方向的動量帳每筆都對平。這能推出哪一步？",
    "responses": [
     {
      "id": "right-scope",
    ...
    "statements": [
     ...
     },
     {
      ...
      "insight": "這一問不能靠攻擊對手過關；要先誠實承認帶方向的動量帳支持他的主張。"
     },
     {
      "id": "p2s3",
    ...
    "playerCorrect": "院士，這兩種碰法我都親手記過——鋼頭、油灰頭，帶方向加起來，每一筆都平。這本帳是對的。（把動量帳推到桌心）我要說的不是它錯了。是有些事，它沒記。",
   ...
   "P1": {
    ...
    "reasonMode": "player",
    "requirePress": true,
    "responsePrompt": "黏土留下了可量的坑。這能反駁院士哪一步？",
    "responses": [
     {
    ...
    "statements": [
     ...
     },
     {
      ...
      "insight": "黏土坑只證明短少伴隨可量的壓陷尺度；完整去向仍不能假裝已對平。",
      "weakTo": {
       "evidence": "J3"
      }
     }
