 ...
 "scenes": [
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人・心聲",
     "text": "哇——伽利略欸。本人。剛剛還在滿地撿球。(頓)那個名字我知道——可課本只寫了他後來留下什麼,沒寫我現在該怎麼讓他相信。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(大笑)好大的口氣。那就陪我找。醜話先說——在比薩,斷言不用錢,證據才值錢。我的話也一樣。",
     "next": "nB3"
    },
    {
     "id": "nB3",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(按住紀錄紙,沒有把它揉掉)先別急著解釋。這一趟確實看見木球落後——但這張紙究竟能支持哪一句?",
     "next": "nB3"
    },
    {
     "id": "nB3",
     ...
     "options": [
      {
       "id": "mixed",
       "text": "這張紙記下木球落後;材質和重量同時不同,原因暫時不歸給其中一項。",
       "next": "nB4"
      },
      {
       "id": "weight",
       "text": "這張紙記下木球落後;木球比鉛球輕,原因應歸在重量差異。",
       "next": "nBwrong"
      },
      {
       "id": "material",
       "text": "這張紙記下木球落後;木球與鉛球材質不同,原因應歸在材質差異。",
       "next": "nBwrong"
      }
     ]
    },
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "紀錄保留:材質與重量同時改變,不能用來歸因。方法筆記:「一次只動一個變因。」",
     "effects": [
      {
       "flag": [
        "q1B",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(盯著自己的手,慢慢張開,開始笑)同一個前提,竟能推出兩個相反的答案。那就不是石頭有問題——是前提自己撞上了自己。",
     "next": "m2"
    },
    {
     "id": "m2",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(極輕)斜面。(把桌面壓斜,珠子滾快;放平,滾慢)同一顆球,坡越緩,它變快得越慢。快慢我改得了;它變快的規矩,我猜改不了。",
     "next": "nb3"
    },
    {
     "id": "nb3",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(盯著主張紀錄,手指微微發抖)把第一段當作一個單位——第二段接近三個,第三段五個,第四段七個。你預測的下一段,是九個。一、三、五、七、九……老天用奇數寫字。",
     "next": "n3b"
    },
    {
     "id": "n3b",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(靠上椅背,長長吐氣)同一條槽、同一種介質——大球如此,小球如此。這裡頭,重量沒有說話的份。它聽時間的話。",
     "next": "c0"
    },
    {
     "id": "c0",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "說服力量表:5。錯誤出示 −1;歸零則辯論中止——你會與伽利略複盤,再從未破的支柱重返。",
     "effects": [
      {
       "debate": "init"
      }
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(走出講堂,不惱)證據沒有少。少的是——你方才把哪一張紙,塞進了哪一句話裡。坐下,我們把失手的地方攤開。",
     "next": "e1"
    },
    {
     "id": "e1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人・心聲",
     "text": "他沒有改信哪一本書,只把我們的數據夾了進去。那不是投降;是他答應繼續讀。",
     "next": "n9"
    },
    {
     "id": "n9",
