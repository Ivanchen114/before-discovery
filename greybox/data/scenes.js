 ...
 "scenes": [
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "年輕人",
     "text": "伽利略・伽利萊,數學教授。薪水只有修辭學教授的十分之一——在比薩,數學看來也只值十分之一。(把小球拋給旅人)來,陪我走一段。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(極輕)斜面。(把桌面壓斜,珠子滾快;放平,滾慢)把「向下」攤平,沿著槽的加速就變小了。",
     "next": "nb3"
    },
    {
     "id": "nb3",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "對。滾多久、滾多遠,全寫在木槽上。(抓起外套)這十一年刨的木頭,總算要派上用場了。來,選傢伙。",
     "next": "n5"
    },
    {
     "id": "n5",
