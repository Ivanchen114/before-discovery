 ...
 "scenes": [
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "(看向辛普里奧帶來的圖)上一頁的答案,到了這張紙上又成了問題。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "這圖先是畫給瞄準用的。它記得住哪一段，我得先看清楚，不能直接拿它當完整路徑。",
     "next": "nb3"
    },
    {
     "id": "nb3",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "Guidobaldo 侯爵的筆記。我能到帕多瓦,他的推薦幫了大忙。(翻開一頁)十六年前,我們把球沾了墨,沿近乎直立的斜板推上去。它留下這道彎;他說,像一條倒掛的鏈子。",
     "next": "n3"
    },
    {
     "id": "n3",
