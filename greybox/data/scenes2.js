  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(指向三筆「分不開」)如果它要等推力用完才下墜,飛出去的那顆就該晚落。可三次都沒有。至少在這套機關聽得出的範圍裡,它一離手,就已經往下掉了。",
     "next": "s1"
    },
    {
     "id": "s1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "choice",
     "speaker": "system",
     "text": "第一張紙:同高一推一放,三輪都聽不出先後。這份紀錄能寫到哪裡?",
     "options": [
      {
       "id": "a",
    ...
    },
    {
     ...
     "type": "choice",
     "speaker": "system",
     "text": "第二張紙:下落高度變成四倍。依你在斜面上量到的「距離跟時間平方走」,飛行時間會變成幾倍?",
     "options": [
      {
       "id": "a",
       "text": "兩倍。",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "往下掉的距離,跟時間自己乘自己走。距離變四倍——那時間該乘上多少,自己乘出來才算。",
     "next": "q2"
    },
    {
     "id": "n4",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "(把四張紙串成一列)不是先飛、再掉。它離手的第一寸,向前和向下就一起開始了;掉得越久,也就飛得越遠。這才是射程跟著下落高度的平方根變化的原因。",
     "next": "n6"
    },
    {
     "id": "n6",
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "第二幕終。船桅待驗預測與三份實驗紀錄已分開收入旅人筆記。",
     "next": "g1"
    },
    {
     "id": "g1",
   ...
   "nodes": [
    {
     ...
     "suspendNext": "gF",
     "hint": "先追問,找出每一句話的破口;再把對得上的證據放到它面前。最後一問,先讀清他攤出的資料,再回答。",
     "next": "gW"
    },
    {
     "id": "gF",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(把你的證據一字排開,對齊三段證詞)東西都在。剛才只是把證據放錯了地方。再走一遍——這句話,哪張紙咬得住?",
     "next": "e1"
    },
    {
     "id": "e1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人・心聲",
     "text": "四年前,他帶走我們的數據;這一次,他把自己的數據交了過來。對手沒有消失,卻開始和我們對同一本帳。",
     "next": "s1"
    },
    {
     "id": "s1",
