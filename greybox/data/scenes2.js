  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(盯著沙盤,很久)出手的速度沒變——變的只有「掉多深」。下墜距離跟著時間的平方走;前進距離只跟時間的一次方走。掉得愈久,球就往前跑得愈遠——所以射程跟下落高度的平方根有關。(抬頭)兩種運動各走各的——合起來,就是墨跡畫出的那道彎。",
     "next": "n5"
    },
    {
     "id": "n5",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "如果物體真的要等推力用盡才下墜,飛得遠的那顆就該讓我們聽見它晚一點落地——可是三輪,一次都沒有。這把結果當成原因了:下墜從離手那一刻就開始,不必等推力用完。",
     "next": "s1"
    },
    {
     "id": "s1",
