   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "先把他理論的一塊地基寫成能驗的問題。他遲早會說:一件物體在同一時間,只能有一種運動。(比劃)想像一條船順流而下,速度不變。我們從桅頂放下一顆球——它應該落在哪裡?",
     "next": "q1"
    },
    {
     "id": "q1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "若它要等推力用完才下墜,飛出去的那顆就該晚落。三輪都聽不出延後。(指向紀錄)現在才有資格說:在這套裝置聽得出的範圍內,下墜從離手就開始,水平前進沒有拖慢垂直下墜。",
     "next": "s1"
    },
    {
     "id": "s1",
