   ...
   "nodes": [
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "1608 年,義大利・帕多瓦。距離斜面實驗與講堂辯論,四年。",
     "next": "n0a"
    },
    {
     "id": "n0a",
     "type": "line",
     "speaker": "旅人(你)",
     "text": "我已不再先找年份。我先看筆記:頁邊多了四年的墨,自己仍沒有老。",
     "next": "n1"
    },
    {
     "id": "n1",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "四年前那張數據紙還在。辛普里奧讀完了,又帶著下一個問題回來。",
     "next": "n6"
    },
    {
     "id": "n6",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "我知道砲彈會走出弧線。但在這裡,知道仍不算數——證據得從頭做。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "Guidobaldo 侯爵的筆記。十六年前,他和我把球沾了墨,沿近乎直立的斜板推上去。(翻開一頁)它留下這道彎。他說,像一條倒掛的鏈子。",
     "next": "n3"
    },
    {
     "id": "n3",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽利略",
     "text": "(盯著沙盤,很久)出手速度沒變,變的只有掉多深。這組數字像是在說:前進和下墜,各按自己的鐘走。(抬頭)但一組射程還不夠。換球,再直接比落地時間。",
     "next": "n5"
    },
    {
     "id": "n5",
