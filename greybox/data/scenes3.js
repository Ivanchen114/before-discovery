 ...
 "scenes": [
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "【合理重建】伽桑狄確實在 1640 年於馬賽的一艘槳帆船上做過這個實驗，結果也確實是「石頭落在桅腳」。但船是透過官方關係取得的；接下來借船的經過、船長其人與那張舊紙，是為了把「誰有權替一份證據作證」演出來而做的虛構。實驗做法、原紙欄位與結論，照史實與物理。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "那就先別替它猜。明天把船怎麼走也記下來，再看這張紙能跟哪一趟放在一起。",
     "next": "x21b"
    },
    {
     "id": "x21b",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（把石子挪開一顆）對。你沒有把自己知道的答案塞回這張紙。它是真的，只是它很小。",
     "next": "n2"
    },
    {
     "id": "n2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（把空白卷宗翻到下一頁）剛才你只說了這張紙真的記下的事。明天先重做舊紙寫的那一趟：解纜後第一段，再看石頭怎麼落。船和地點先不換；你來安排怎麼放手、怎麼記船速、誰記落點。每做一回，就留一張原紙。",
     "next": "x6"
    },
    {
     "id": "x6",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（指著船速空欄）這張紙哪裡寫了「平穩」？你說的是答案，不是它留下的紀錄。",
     "next": "xa",
     "_keep": true
    },
    {
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "先重做他看過的那一趟——解纜後第一段。今天岸上有人記船位，所以這一次，船到底是越走越快還是走穩，紙上會有答案。",
     "next": "n4"
    },
    {
     "id": "n4",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "他沒有看到這份卷宗。（把手稿和《對話》並排放好）不過他問的那句話，我們替他量完了。",
     "next": "n6"
    },
    {
     "id": "n6",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "（旅人把筆記翻回最前面那一頁。空白頁上有一行不是他寫的字——很舊了，墨已經褐掉。）",
     "next": "x4"
    },
    {
     "id": "x4",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "維達爾船長",
     "text": "那還是在補寫。你知道的答案不能冒充那一趟真的記過的船況。",
     "next": "c1"
    },
    {
     "id": "n3",
