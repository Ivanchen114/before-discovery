...
(function (root) {
 ...
 "publicDemo": {
  "purpose": "私人結果可以被事後說成挑了漂亮船速、暗中多推，或只成功一次。這次讓反對者在結果出現前檢查程序。",
  "tokenRule": "木籌不是拿來投票決定真相。它只是不讓任何人在結果出來後，偷偷改口。",
  "steps": [
   {
    "id": "baseline",
    "speaker": "艦長",
    "question": "停船時本來就落在桅腳。船動之後，拿什麼比較？",
    "action": "公開停船時的落點基準",
    "reply": "艦長：好。先讓大家看見船不動時，落點本來就會有一點散。"
   },
   {
    "id": "stable-window",
    "speaker": "艦長",
    "question": "你是不是只挑了一段看起來最漂亮的船速？",
    "action": "公開怎麼判定近似穩速",
    "reply": "艾蒂安：鼓點和岸標都留著，誰都能重新判斷這段船速。"
   },
   {
    "id": "no-push",
    "speaker": "艦長",
    "question": "放手的人若偷推一下，也能做出漂亮結果。",
    "action": "公開不額外推石頭的釋放法",
    "reply": "艦長：門閂由我抽。這次不靠你們互相作證。"
   },
   {
    "id": "seal-prediction",
    "speaker": "艦長",
    "question": "結果出來後，誰都能說自己早就猜中。你怎麼留下原本的預測？",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "碼頭木板畫著船頭、桅腳、船尾三格。艦長、槳手和商人各把一枚預測木籌放進一格。",
     "next": "n2"
    },
    {
     "id": "n2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "奔馬會上下顛，也會忽快忽慢。先別拿它和近似穩速的船混在一起。",
     "next": "q1"
    },
    {
     "id": "q1",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "艦長",
     "text": "演示做得漂亮，還不夠。風、船速改變，還有兩張看起來不同的路徑，都要回答。",
     "next": "e1"
    },
    {
     "id": "e1",
