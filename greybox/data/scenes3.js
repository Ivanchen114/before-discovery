   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "1609 年。頁角還留著旅人寫下的問題：沒有東西繼續推它，它為什麼還在走？年月折進紙縫。1632 年的《對話》覆上舊問題，把它換成另一個問法：船正在向前時，桅頂的石頭會落在哪裡？1640 年秋，法國・馬賽。",
     "next": "n2"
    },
    {
     "id": "n2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（闔起《對話》，望向碼頭上的桅杆）我想借一艘真的船，把書裡那個問題帶到海上試一次。",
     "next": "s1"
    },
    {
     "id": "s1",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（走到踏板前；艦長正在核對裝貨單）有人說：地球若在動，塔頂放下的石頭就該落在塔後。可塔頂的石頭總落在塔腳。",
     "next": "n2"
    },
    {
     "id": "n2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "艦長",
     "text": "覺得手上的東西夠了，就回碼頭找我。可別等我問到一半，才說還少一張紙。",
     "next": "g1"
    },
    {
     "id": "g1",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "第二天，船員把門閂、等拍鼓、岸標紙與空白卷宗搬上船。艦長留在踏板外，沒有跨上甲板。",
     "next": "n2"
    },
    {
     "id": "n2",
     "type": "line",
     "speaker": "馬蒂厄",
     "text": "每趟原紙一下船就封。艦長、伽桑狄和你，誰都不能等落點出來才補條件。",
     "next": "n3"
    },
    {
     "id": "n3",
     "type": "line",
     "speaker": "伽桑狄",
     "text": "你不必先收齊才上台。做出第一條能站住的斷言，就可以去找他；答不完，再把問題帶回來。",
     "next": "e1"
    },
    {
     "id": "e1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "石頭離手時，已經和船一起向前。拿碼頭當不動的尺，它一邊向前、一邊落下；拿桅杆當不動的尺，它近乎直直落下。",
     "next": "t1"
    },
    {
     "id": "t1",
