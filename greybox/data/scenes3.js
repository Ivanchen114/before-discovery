...
(function (root) {
 ...
 "startScene": "C0-1",
 "conclusionLint": {
  "note": "第三章不以後世名詞替玩家代答；這些名稱若要加入，必須另立玩家命名節點與揭曉邊界。",
  "rules": [
   {
    "term": "參考系",
    "kind": "forbid"
 ...
 "evidenceSummary": {
  ...
  "G2": "封閉船艙裡，停泊與平駛各做三回；六回的水面都沒有固定偏向，落球也都在放手點正下方。岸紙再確認哪三回是在平駛。",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "伽利略留下的問題還在：沒有東西繼續推它，它為什麼還在走？",
     "next": "n1b"
    },
    {
     "id": "n1b",
     "type": "line",
     "speaker": "stage",
     "text": "（旅人還坐在帕多瓦的橋頭。他把筆記闔上，又打開，想把月球上那道弧再看一次。）",
     "next": "x1"
    },
    {
     "id": "x1",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（把書轉過來給他看）皮耶・伽桑狄。這邊的教士，也教點數學。",
     "next": "n4"
    },
    {
     "id": "n4",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（沒注意到他愣了一下，望向碼頭上真正的桅杆）他寫的是一艘走得又直又穩、沒有風浪的船。書上的船不會晃。",
     "next": "n6"
    },
    {
     "id": "n6",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（第一次正眼看他）對。書裡那艘不會晃，外面這艘會。要是兩邊結果不同，我們就得知道差在哪裡。",
     "next": "s1"
    },
    {
     "id": "s1",
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "【合理重建】史料可確認伽桑狄曾在馬賽的槳帆船上做落石實驗；本章依書信線索採用 1640 年。接下來的借船過程、維達爾船長、舊紙與卷宗欄位，都是本作為了演出「誰有權替一份證據作證」所作的合理重建；實驗結果與史實邊界留到章末分開說明。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "維達爾船長",
     "text": "（抽出一張皺紙，吹了一下）以前也有人做過。紙上寫：解纜後第一段，石頭落在桅後。",
     "next": "x20"
    },
    {
     "id": "x20",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "維達爾船長",
     "text": "（第一次看向旅人）先把你說的那一欄真的記出來，再談配哪一趟。",
     "next": "x21"
    },
    {
     "id": "x21",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "借船單上寫的是明天早上。這半天，伽桑狄把舊紙攤在碼頭邊的石台上，壓了四顆石子。",
     "next": "x2"
    },
    {
     "id": "x2",
   ...
   "nodes": [
    ...
    },
    {
     ...
     "options": [
      {
       "id": "all",
       "text": "這張紙記了一次落在桅後，所以所有船上落石都會落在桅後。",
       "require": {
        "flagAbsent": "oldPaperAnswerBlurted"
       },
       "effects": [
        {
         "rep": -1,
      ...
      {
       "id": "fake",
       "text": "船速、鼓點和岸標都沒記，我看不出這張紙還能支持什麼。",
       "next": "f1"
      }
     ]
    },
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（把石子挪開一顆）對。你沒有把自己以為知道的說法塞回這張紙。它是真的，只是能說的範圍很小。",
     "next": "n2"
    },
    {
     "id": "n2",
     "type": "system",
     "speaker": "system",
     "text": "◆ 舊紙已收入卷宗：它確實記著一次「落在桅後」；但那一趟船速沒記，目前只能放在「船況不明」。",
     "next": "x5"
    },
    {
     "id": "x5",
     "type": "line",
     "speaker": "stage",
     "text": "（石台後面傳來腳步聲。維達爾船長沒有走近，只把借船單往旅人這邊推了一寸，又回到船上。）",
     "next": "n3"
    },
    {
     "id": "n3",
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（把空白卷宗翻到下一頁）明天先重做他那一趟。船不換，地點不換。",
     "next": "x5a"
    },
    {
     "id": "x5a",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（指著船速空欄）這張紙哪裡寫了「平穩」？你說的是結論，不是它留下的紀錄。",
     "next": "xa",
     "_keep": true
    },
    {
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "那就先別丟。至於這張紙能說到多遠——其他欄位，你自己再看一遍。",
     "next": "xf",
     "_keep": true
    },
    {
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "馬蒂厄",
     "text": "（把封蠟擱在卷宗旁）條件先填好，等石頭落地再記落點。原紙一下船，我就封。封了就直接送到他手上，你我都改不了。",
     "next": "n3"
    },
    {
     "id": "n3",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "所以這一趟，船到底是越走越快、還是走穩，紙上會有答案——不用再靠誰的印象。",
     "next": "n5"
    },
    {
     "id": "n5",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "（旅人在甲板上找了個位置站好，把筆記翻到空白頁。他寫了兩行條件，抬頭想確認一下桅杆的高度。）",
     "next": "x4"
    },
    {
     "id": "x4",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "馬蒂厄",
     "text": "（這才抬頭）水沒有往哪一邊斜。至少現在沒有明顯加槳或收槳。真要說船走穩，還得等艾蒂安的岸紙。",
     "next": "x11"
    },
    {
     "id": "x11",
    ...
    },
    {
     ...
     "system": "ship",
     "phase": "dossier",
     "hint": "一次只查一件事。先排好做法、跑一趟，再用原紙寫下一句不超過紀錄的判斷。紙還不夠，也能先回碼頭；哪裡被問住，就帶著那個缺口回船補做。",
     "until": {
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "（第三輪的最後一句話講完之後，碼頭上有一段沒有人說話的時間。）",
     "next": "x2"
    },
    {
     "id": "x2",
     "type": "line",
     "speaker": "stage",
     "text": "（維達爾船長把岸紙和船紙取下來，按同一趟、同一鼓號並排釘回；兩張紙各自的封蠟都朝外，卷宗編號貼在一起，中間沒有留空。）",
     "next": "x3"
    },
    {
     "id": "x3",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "維達爾船長",
     "text": "我問完了。（指那並排的兩張）同一趟、同一鼓號。一張從碼頭量，一張從桅杆量。這一組，我認。",
     "next": "x7"
    },
    {
     "id": "x6",
    ...
    },
    {
     ...
     "speaker": "旅人・心聲",
     "osPurpose": "private_hypothesis",
     "text": "……八年前那本書，也把一個說法放進問答裡，一路追到底。連反駁都是寫書的人自己留下的。",
     "next": "g1"
    },
    {
     "id": "g1",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "官員",
     "text": "（筆懸在結果簿上）你們跑了這麼多趟。結果欄到底要我寫什麼？",
     "next": "x1"
    },
    {
     "id": "x1",
     ...
     "options": [
      {
       "id": "bounded",
       "text": "「寫：這次排除了『承載物前進，落石就必定落後』。至於地球有沒有動，我們沒有直接量。」",
       "next": "x2"
      },
      {
       "id": "earth-moves",
       "text": "「寫：落石跟著船走，所以這次已經證明地球會動。」",
       "next": "x1_over"
      },
      {
       "id": "nothing-learned",
       "text": "「寫：落點沒有規律，這些紙還不能留下任何結果。」",
       "next": "x1_under"
      }
     ]
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "船的紙只排除「前進就必定落後」。我們沒有把地球搬上這條船，也沒有直接量它。把結果欄收窄。",
     "next": "x1"
    },
    {
     "id": "x1_under",
     "type": "line",
     "speaker": "維達爾船長",
     "text": "若真沒有規律，走穩時的紙就不會一趟趟落在桅腳附近。不能把有限結果寫成沒有結果。",
     "next": "x1"
    },
    {
     "id": "x2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "今天沒有量到地球。我們只拆掉一個擋在路上的反對。就這樣。",
     "next": "x5"
    },
    {
     "id": "x5",
     ...
     "speaker": "旅人・心聲",
     "osPurpose": "cross_chapter_memory",
     "text": "這麼多趟，換掉一句「所以地球不會動」。聽起來不划算——可是那句話擋在那裡快兩千年了。",
     "next": "n2"
    },
    {
     "id": "n2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "維達爾船長",
     "text": "（在借船與岸上船況欄簽名）我只簽我在岸上核對過的：借的是哪艘船，何時離岸，何時加槳或收槳。",
     "next": "n3b"
    },
    {
     "id": "n3b",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "艾蒂安",
     "text": "岸紙由我簽。每一趟離岸、加槳、收槳的時刻也一起附上；少了那些，岸紙就沒法和船紙對齊。",
     "next": "n3d"
    },
    {
     "id": "n3d",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "維達爾船長",
     "text": "（把舊紙翻到背面。背面的角落有一行小字，墨很淡）洛朗・維達爾。一六三二年。",
     "next": "x14"
    },
    {
     "id": "x14",
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（把舊紙拿起來，看那行字，再看他）你辯到一半才說「我的舊紙」。",
     "next": "x15"
    },
    {
     "id": "x15",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "名字會被引用。後面的人只讀得到名字，讀不到裡面。（把筆放上桌）取名的人要為那件事負責。",
     "next": "x3"
    },
    {
     "id": "x3",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（看了他一眼，沒有追問）那就更該是你。你不會回來替它辯護，所以這個名字不能替卷宗說過頭。",
     "next": "c1"
    },
    {
     "id": "x4b",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "（把封面吹乾）三個都不完整。名字本來就裝不下一整份卷宗。",
     "next": "s1",
     "_keep": true
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "講的是艙裡看到的。（寫下）那船在外面走的那一段，就不在名字裡了。",
     "next": "x5",
     "_keep": true
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "講的是最難的那一趟。（寫下）可是走穩的那三回，聽起來就變成配角。",
     "next": "x5",
     "_keep": true
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "講的是兩邊怎麼記。（寫下）不過別人光看名字，不會知道我們量了什麼。",
     "next": "x5",
     "_keep": true
    },
    {
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "（門外有人送信進來。伽桑狄接過，拆了。他讀完，沒有讀出聲。他把信放在桌上，手還壓在上面。）",
     "next": "x4"
    },
    {
     "id": "x4",
    ...
    },
    {
     ...
     "speaker": "旅人・心聲",
     "osPurpose": "cross_chapter_memory",
     "text": "他把空白冊子丟給我時說：「送你。想在這座城市開口,先學會把看見的寫下來。」",
     "next": "x12"
    },
    {
     "id": "x12",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "（伽桑狄把《對話》的封面拂平。他做得很慢，像在把一件已經整齊的東西再整齊一次。）",
     "next": "x18"
    },
    {
     "id": "x18",
     "type": "line",
     "speaker": "伽桑狄",
     "text": "他沒有看到這份卷宗。（把手稿和《對話》並排放好）不過他問的那句話，我們替他在這艘船上量了一回。",
     "next": "n6"
    },
    {
     "id": "n6",
     ...
     "speaker": "旅人・心聲",
     "osPurpose": "time_dislocation",
     "text": "五十多年前，伽利略把第一本空白筆記塞進我手裡。現在他走了，我卻還是那天的模樣。",
     "next": "g1"
    },
    {
     "id": "g1",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "旅人把岸上紙與船上紙攤開，再把船上那張推到岸上那張下面。原紙一張不少；畫歪的線、改過的句子，也都留著。",
     "next": "n2"
    },
    {
     "id": "x1",
    ...
    },
    {
     ...
     "speaker": "旅人・心聲",
     "osPurpose": "naming",
     "text": "同一顆石頭，同一次落下。只是記它的人，站在兩個地方。",
     "next": "t1"
    },
    {
     "id": "x2",
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "這一份卷宗已封存。旅人筆記新增未解問題：「月亮為什麼沒有沿直線離開？」",
     "next": "end"
    },
    {
     "id": "end",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "（信譽歸零。維達爾船長把卷宗闔上；伽桑狄沒有收走原紙，只把越過資料的那句話圈起來。）",
     "next": "n2"
    },
    {
     "id": "n2",
     "type": "line",
     "speaker": "伽桑狄",
     "text": "原紙沒有背叛你，是你把它說得太大。把那句收回到紙上真的有的欄位，我們再談。",
     "next": "c1"
    },
    {
     "id": "c1",
     ...
     "options": [
      {
       "id": "withdraw",
       "text": "「我撤回超過原紙的部分。沒有量到的事，我不再說成已經證明。」",
       "effects": [
        {
         "rep": 1,
         "reason": "主動撤回越過原紙的斷言，重新標明資料邊界"
        },
        {
         "flagClear": "repLocked"
        }
      ...
      {
       "id": "discard-paper",
       "text": "「這張舊紙沒記完整，乾脆整張不算。」",
       "next": "w1"
      },
      {
       "id": "fill-blank",
       "text": "「紙上沒記船速，但我們知道答案，可以把『走穩』補進去。」",
       "next": "w2"
      }
     ]
    },
    {
     ...
     "type": "line",
     "speaker": "伽桑狄",
     "text": "它確實記了一次落點。你要留下它，也要留下它沒記的欄。",
     "next": "c1"
    },
    {
     "id": "w2",
     "type": "line",
     "speaker": "維達爾船長",
     "text": "那還是在補寫。你以為知道的說法，不能冒充那一趟真的記過的船況。",
     "next": "c1"
    },
    {
     "id": "n3",
