  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "哈雷",
     "text": "（從卷宗底層抽出那張切線紙，指著角落被硯壓過的弧線）你第一晚讓月亮照著弧走。（把它跟排好的版並排）現在你知道那條弧是誰畫出來的了——不是月亮自己。是這本書裡的每一頁，一起畫的。",
     "require": {
      "event": {
       "t": "choice",
       "at": "D1-1/c1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "第一晚留下的切線紙、後來量成的短差，以及一路退下的錯稿，疊進同一只木匣。蠟油封上時，沒有一張曾真正出現的紙被抽走。",
     "next": "g1"
    },
    {
     "id": "e1",
