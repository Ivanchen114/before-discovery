   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "第三章旅人筆記的末頁。馬賽港的紙帶已乾，頁角壓著一粒鹽：如果放手不會清除原有運動，月亮為什麼沒有沿直線離開？",
     "next": "n2"
    },
    {
     "id": "n2",
     "type": "line",
     "speaker": "旅人・心聲",
     "text": "伽利略不在了。伽桑狄的手稿還在往前走；那個月亮問題，也還在。",
     "next": "c1"
    },
    {
     "id": "c1",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "1665｜Woolsthorpe, Lincolnshire。Cambridge 因瘟疫停課，一位二十二歲的學生回到鄉間。",
     "next": "n5"
    },
    {
     "id": "n5",
