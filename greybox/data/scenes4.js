   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "第三章筆記末頁。紙角壓著一粒乾掉的鹽。旅人剛寫的字還沒乾：如果放手不會清除原有運動，月亮為什麼沒有沿直線離開？",
     "next": "n2"
    },
    {
     "id": "n2",
     "type": "line",
     "speaker": "旅人(你)",
     "text": "（指腹按在那行字上，墨蹭到指節）石頭離開桅杆，還帶著原來的前進。這件事我們量了半個月，量到維達爾船長都認了。",
     "next": "n3"
    },
    {
     "id": "n3",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "我知道自己在問什麼。我不知道下一頁會把我帶到誰面前。",
     "next": "n5"
    },
    {
     "id": "n5",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "紙縫打開成真正的果園。旅人跌進濕草，手掌撐在冰冷的地上；身後已沒有海聲。",
     "next": "a2"
    },
    {
     "id": "a2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "到樹頂，蘋果照樣落；那股勁沒有在枝頭斷掉。那到雲上呢？到了月亮那裡呢？",
     "next": "n12"
    },
    {
     "id": "n12",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "我只知道一件做過的事：放手不會拿走原有的前進。至於月亮——",
     "next": "n14"
    },
    {
     "id": "n14",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "（把蘋果拋回掌心，轉身要走）這幾個月，我聽自己猜得夠多了。",
     "next": "n17"
    },
    {
     "id": "n17",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "（圈住三個落點）風有這麼準？每一趟，都吹回同一隻手掌大的地方？重選。",
     "next": "c1"
    },
    {
     "id": "ok1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "（把筆遞給旅人，退開半步）先拿掉所有拉扯。地球不拉它，什麼都不拉它。",
     "next": "n3"
    },
    {
     "id": "n3",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "（用指甲截住那段弧）你把要證明的圓，先塞進答案裡了。重選。",
     "next": "w2"
    },
    {
     "id": "w2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "（把蘋果放在月亮與地球之間）這是替它多加了一次拉。題目說，什麼都不加。重選。",
     "next": "c1"
    },
    {
     "id": "ok1",
     "type": "line",
     "speaker": "stage",
     "text": "旅人沿選中的方向畫下一條直線。牛頓沒有說話，只把紙推到鎮紙旁。",
     "next": "ok2"
    },
    {
     "id": "ok2",
     "type": "line",
     "speaker": "牛頓",
     "text": "先把你在看結果以前選的路封住。別等它走過，才說自己原本就知道。",
     "next": "e1"
    },
    {
     "id": "e1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "上：牛頓的地表估算——自由落下一秒約 4.9 公尺。下：旅人的第一章紀錄——等時段距離比為 1、3、5、7，總距離隨時間平方增加。",
     "next": "n4"
    },
    {
     "id": "n4",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "那你記得比多數人清楚。上面這張是我估的，不是你量的。兩張紙分開放，別混。",
     "next": "n8"
    },
    {
     "id": "n8",
     "type": "system",
     "speaker": "system",
     "text": "兩張紙保留各自的來源標籤與限制；旅人的第一章紀錄不包含垂直落下一秒的數值。",
     "next": "c0"
    },
    {
     "id": "c0",
    ...
    },
    {
     ...
     "system": "orbit",
     "phase": "scale",
     "hint": "先封存月球處量級賭注，再完成 60 秒到 1 秒的平方換算與 60×60 關係判讀；蠟封猜錯也保留。",
     "until": {
      "orbit": "k2"
     },
     "next": "n9"
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "六十秒後，月亮離開切線的距離，和地表一秒的落下碰上了。距離每遠一倍，這股勁就弱到四分之一；照這條規矩算，地上那個數跟天上這個數對得上。",
     "next": "n11"
    },
    {
     "id": "n11",
     "type": "line",
     "speaker": "旅人(你)",
     "text": "所以拉著蘋果掉下來的那股勁，和拉著月亮的那股勁，是同一股；月亮遠得多，所以弱得多。",
     "next": "n12"
    },
    {
     "id": "n12",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "先記下。它只回答了月亮。天上還有火星、木星和幾十年才回來一次的東西——它們照不照這條規矩，今天一個都沒問過。",
     "next": "n14"
    },
    {
     "id": "n14",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "取得誘答卡「繩球演示」：它只借了幾何，不能當作引力機制。",
     "next": "n22"
    },
    {
     "id": "n22",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "月亮是一路連著走的，可是筆不能一路連著算。我把它切成一小段、一小段——每一小段，叫一拍。",
     "next": "n24"
    },
    {
     "id": "n24",
     "type": "line",
     "speaker": "牛頓",
     "text": "一拍之內，它照原來的方向走一小段；走完，我再把方向朝地球扳一點點。然後下一拍。",
     "next": "n25"
    },
    {
     "id": "n25",
     "type": "line",
     "speaker": "牛頓",
     "text": "切得越細，畫出來的路就越接近真正的路。我今天切得很粗——因為我只有一雙手。",
     "next": "n26"
    },
    {
     "id": "n26",
    ...
    },
    {
     ...
     "system": "orbit",
     "phase": "orbit-rule",
     "hint": "封存方向、初速、箭長與形狀預測後才可落第一拍。玩家親手重對三拍；牛頓沿同一規則續畫二十七拍。錯墨、蠟封與多組可行配對都保留。",
     "until": {
      "orbit": "k1"
     },
     "next": "n29"
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "差的那一點點，就是它不是圓的意思。我畫的是三十步；真正的月亮一直在走。步子切得越細，帶子越窄，可它永遠是一條帶子，不是一條線。",
     "next": "n33"
    },
    {
     "id": "n33",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "（指固定方向那張）這條線我認得。第二章，桌緣彈射，一模一樣。",
     "next": "n35"
    },
    {
     "id": "n35",
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "取得誘答卡「方向卡」。山頂大砲圖卡已放到桌邊；圖上的三條路可與作圖紙逐一對照。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "本場不取得證據。虎克 1679-11-24 提出切向直進與中央吸引的合成，1680-01-06 提出平方反比猜想；牛頓完成軌道證明、球體處理與跨天體整合。兩人的真實貢獻都保留。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "system": "orbit",
     "phase": "planets",
     "hint": "封存前先想，再分別滴蠟封住火星與木星週期；資料只能由哈雷在封存後拆開。刻痕帶、兩種有餌誘惑與錯誤斷言都必須留帳。",
     "until": {
      "orbit": "k3"
     },
     "next": "n37"
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "哈雷",
     "text": "（小心拿起牛頓的計算紙）好。這兩個封口，比你的保證有用。",
     "next": "n39"
    },
    {
     "id": "n39",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "哈雷",
     "text": "每一格，先看依據，再蓋章。對上了——有數字而且對了；講得通——只有說法，沒數字可對；對不上——有數字，錯了。",
     "next": "n24"
    },
    {
     "id": "n24",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "哈雷",
     "text": "牛頓不能蓋——規矩是他的。我不能蓋——書是我要印的。你呢？你什麼都不要。",
     "next": "n26"
    },
    {
     "id": "n26",
     "type": "line",
     "speaker": "哈雷",
     "text": "帳房裡最值錢的，不是漂亮的總數，是你沒有藏掉哪一筆。",
     "next": "n27"
    },
    {
     "id": "n27",
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "蓋錯不罰；桌上數字會把錯章頂回來。三份順序由玩家決定。借條只能由玩家貼，拒絕後不得由系統補生；封條與證據包必須依實際借條狀態生成。",
     "next": "e1"
    },
    {
     "id": "e1",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "三份資料都已過帳。哈雷只把實際產生的借條連同紀錄、虎克書信和封存預測收進木匣；玩家拒絕過的借條沒有憑空出現。",
     "next": "n30"
    },
    {
     "id": "n30",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "印刷工・合成人物",
     "text": "兩個窗口。這個月只剩兩個。稿子進版框後再整頁重排，花的不只一張紙。",
     "next": "n3"
    },
    {
     "id": "n3",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "版框有六個證明槽。最後一槽仍寫著二十年前留下的問題：「憑什麼從地心量？」同尺紙不能替代答案。",
     "next": "n6"
    },
    {
     "id": "n6",
    ...
    },
    {
     ...
     "type": "system",
     "speaker": "system",
     "text": "史實邊界：《原理》第一卷命題 LXX、LXXI 與 LXXIV 分別處理球殼內部、殼外等效球心與完整均勻球的疊合；「1686 交到印刷台」是排版演出，不是首次形成日期。",
     "next": "n13"
    },
    {
     "id": "n13",
    ...
    },
    {
     ...
     "system": "orbit",
     "phase": "proof",
     "hint": "親手完成六槽證明鏈、放入球殼頁、保持預測早於觀測，精確寫虎克的兩項貢獻，接回哈雷／佛蘭斯蒂德／牛頓的來源；再由玩家把旅人名條移出作者欄、誠實保留機制空白並壓下印刷機。",
     "until": {
      "orbit": "k5"
     },
     "next": "n17"
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "我們算出了作用與運動的關係，沒有一頁告訴你它如何穿過空間。那就讓別人來找它錯在哪裡。",
     "next": "n20"
    },
    {
     "id": "n20",
   ...
   "nodes": [
    ...
    },
    {
     ...
     "options": [
      {
       "id": "withdraw",
       "text": "「我撤回超過來源的署名與機制結論；只保留這批紙真正接得起來的部分。」",
       "effects": [
        {
         "rep": 1,
      ...
      {
       "id": "erase-source",
       "text": "「保留最後的證明就好；虎克的信不必再列。」",
       "next": "w1"
      },
      {
       "id": "fill-mechanism",
       "text": "「機制欄不能留白；先寫成已證明，日後再補來源。」",
       "next": "w2"
      }
     ]
    },
