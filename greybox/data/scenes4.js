  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "（把筆遞給旅人，退開半步）先拿掉所有拉扯。假設地球不拉月亮，其他東西也不拉。別替月亮畫完一圈。",
     "next": "n3"
    },
    {
     "id": "n3",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "好。沒有拉扯，月亮會照這條直線走。可月亮沒有離開。那先問一件我們現在算得了的事：如果真有東西把月亮拉回去，到了月亮那麼遠，還剩多少？",
     "next": "n4"
    },
    {
     "id": "e1",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "所以，沒有拉扯時，月亮會照原來的方向走，不會自己沿圓弧。",
     "next": "n6"
    },
    {
     "id": "n6",
     "type": "line",
     "speaker": "牛頓",
     "text": "對。先別急著畫圓。把地上的落下和月亮那裡的偏折換成同一把尺，看看那股勁到了月亮還剩多少。",
     "next": "g1"
    },
    {
     "id": "g1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "那你記得比多數人清楚。上面這張是我估的。你帶來的數字另起一張——兩張紙分開放，別混。先別算：月亮六十秒偏了那麼一點，換成一秒，你押它還剩多少？先蓋起來，算完再翻。",
     "next": "n8"
    },
    {
     "id": "n8",
    ...
    },
    {
     ...
     "type": "choice",
     "speaker": "system",
     "text": "兩張紙記的時間不同。要先把月亮六十秒的偏折換成一秒。月距的數字從哪裡來，也可以先問清楚。",
     "options": [
      {
       "id": "ask",
    ...
    },
    {
     ...
     "system": "orbit",
     "phase": "scale",
     "hint": "先猜 60 秒換成 1 秒後會剩多少；再換算、比較，最後看出 60 和 3600 的關係。猜錯的答案會保留。",
     "until": {
      "orbit": "k2"
     },
     "next": "n9"
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "換成同一秒後，地表那個數和月亮的偏折差不多接得上。看來，它們可能都照著同一條規矩：距離越遠，作用越弱，而且按距離平方減小。",
     "next": "n12"
    },
    {
     "id": "n12",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "先記下。我們只量過月亮。天上還有火星、木星，還有幾十年才回來一次的東西。它們是不是也照這條規矩，我們今天一個都還沒問。",
     "next": "n15"
    },
    {
     "id": "n14",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "（在紙角寫問號）這兩張紙只證明一件事：如果從地心量，數字就對得上。但紙上沒有一句能證明，為什麼可以從地心量。",
     "next": "n22"
    },
    {
     "id": "n22",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "對。一拍之內，月亮先照原來的方向走。走完，我再把方向朝地球扳一點點。切得越細，畫出的路就越接近真正的路。",
     "next": "n26"
    },
    {
     "id": "n26",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "同樣一扳，對慢的來說太重，對快的來說太輕。扳多少，得配上它跑多快。這就是眼前要解的：同一套規矩做三十拍，它會撞回地球、逃出去，還是被扳成一條繞住的路？前三拍由你落筆，後面牛頓只照原規矩續畫。",
     "next": "e1"
    },
    {
     "id": "e1",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人(你)",
     "text": "照這個速度，每一拍都往地球偏這麼多，三十拍下來，月亮都還留在同一條窄帶裡。",
     "next": "n32"
    },
    {
     "id": "n32",
     "type": "line",
     "speaker": "牛頓",
     "text": "這一句可以留下，但別把紙帶當成天空本身。我們一次只畫一拍。步子切得越細，帶子會越窄，真正的月亮卻一直在走。",
     "next": "n33"
    },
    {
     "id": "n33",
     "type": "line",
     "speaker": "stage",
     "text": "牛頓把錯規則的紙逐張攤開：內捲、外張、只朝固定方向彎下的弧線、繞錯墨點的彎路，以及什麼都不改時的切線直路。",
     "next": "n34"
    },
    {
     "id": "n34",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "哈雷",
     "text": "先看你們手上的線索：離得遠，拉得弱；拉得弱，走得慢，路又更長。兩件事疊起來，遠一倍，一年就不只長一倍。火星和木星各要多久，你們先押一個大約範圍，滴上蠟。我再開包。",
     "next": "n30"
    },
    {
     "id": "n30",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "哈雷",
     "text": "（小心拿起牛頓的計算紙）封口在先，觀測在後。火星和木星都對上了。這兩筆比你的保證有用，但還不能替整片天空作保。",
     "next": "n39"
    },
    {
     "id": "n39",
