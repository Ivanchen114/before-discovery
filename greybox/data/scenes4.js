  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "牛頓",
     "text": "先把我們採用的地球半徑寫在紙邊。觀測數字不動；要改，只能改我們猜這股作用會怎麼隨距離變弱。",
     "next": "e1"
    },
    {
     "id": "e1",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "佛蘭斯蒂德・書信",
     "text": "我記的不是那團光像什麼，而是它每一夜在星群間移到哪裡。若你說兩疊紙記的是同一顆彗星，就算出一條能依序通過這些位置的路。",
     "next": "n1b"
    },
    {
     "id": "n1b",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "哈雷・短箋",
     "text": "你們可以先送一份只寫到行星的短稿，也可以錯過這輪，等彗星算完再送。你們想多久都行；真正記進帳裡的，只有送樣或延後。",
     "next": "n3"
    },
    {
     "id": "n3",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "system": "orbit",
     "phase": "proof",
     "hint": "接好五段證明，寫清楚虎克做了什麼，再把證明、觀測與出版工作各自放回正確的人名下。最後，決定結論能寫到哪裡。錯稿會保留，但可繼續重排。",
     "until": {
      "orbit": "k5"
     },
     "next": "n8"
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "印刷機壓下最後一頁。切線、向內偏折、距離律和幾次事前預測都印了進去；每一份工作也連回了做它的人。只有「引力怎麼隔著空間起作用」那一欄，仍是空白。",
     "next": "n2"
    },
    {
     "id": "n2",
