   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "stage",
     "text": "筆記自己翻頁。倫敦的墨味折進紙縫，露出一座鄉間莊園：長窗、書牆、燒著的壁爐。",
     "next": "n2"
    },
    {
     "id": "n2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "旅人・心聲",
     "text": "那是《原理》。裝訂線都拆開了——有人把它拆開來，一頁一頁讀。",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "杜夏特萊",
     "text": "埃米莉・杜・夏特萊。你來得正好——也可能很不巧。這屋裡最近只吵一件事。",
     "next": "x4"
    },
    {
     "id": "x4",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "杜夏特萊",
     "text": "（順著他的視線）拆開才好一頁一頁對。旁邊那些，是我自己的清樣。",
     "next": "x6"
    },
    {
     "id": "x6",
   ...
   "nodes": [
    {
     ...
     "type": "line",
     "speaker": "杜佩院士",
     "text": "運動之量，就是質量乘速度。方向也要算。撞前有多少，撞後就有多少。至於萊布尼茲那個還要把速度自乘的『活力』——那是憑空多想出來的。",
     "next": "x2"
    },
    {
     "id": "x2",
   ...
   "nodes": [
    ...
    },
    {
     ...
     "options": [
      {
       "id": "ledger",
       "text": "「一本問帶方向的 mv 前後變不變，另一本問 mv² 前後變不變。」",
       "effects": [
        {
         "rep": 1,
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "杜夏特萊",
     "text": "先別比哪個數字大。你要問的是：同一場碰撞前後，每一本帳記的數有沒有變。這句，你自己寫。",
     "next": "q1"
    },
    {
     "id": "bad2",
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "杜夏特萊",
     "text": "對。先把兩種算法各算清楚——哪一本、在什麼時候，對得平。這題該怎麼問，等帳記完再說。",
     "next": "x3"
    },
    {
     "id": "x3",
  ...
  },
  {
   ...
   "nodes": [
    ...
    },
    {
     ...
     "type": "line",
     "speaker": "杜夏特萊",
     "text": "先量你自己的，再判斷坑深跟速度怎麼走。最後才翻他們的數字。",
     "next": "lab3"
    },
    {
     "id": "lab3",
